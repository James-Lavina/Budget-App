...
<body class="min-h-screen bg-slate-50/60 font-sans antialiased text-slate-800">
   ...
   <section class="pt-8 pb-16 sm:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
       <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
           ...
           <!-- Hero Right Graphic: Student Mascot & Lifestyle Graphic Scene -->
           <div class="lg:col-span-6 relative flex items-center justify-center">
               ...
               <div class="w-full bg-gradient-to-tr from-indigo-100/70 via-purple-50/50 to-indigo-50/80 p-6 sm:p-10 rounded-[2.5rem] border border-white shadow-2xl relative">
                   ...
                   <div class="bg-white/90 backdrop-blur-md rounded-3xl p-8 shadow-sm border border-slate-100/80 relative flex flex-col items-center justify-center min-h-[360px] space-y-6">
                       ...
                       <div class="absolute -top-5 bg-indigo-600 text-white px-5 py-2.5 rounded-2xl shadow-lg shadow-indigo-600/30 text-xs sm:text-sm font-bold flex items-center gap-2 border-2 border-white z-20">
                       ...
                       <div class="absolute top-12 -left-2 sm:-left-4 bg-white/95 backdrop-blur-md px-3.5 py-2 rounded-2xl shadow-md border border-slate-100 flex items-center gap-2.5 transform -rotate-3 hover:rotate-0 transition-transform z-10">
                       ...
                       <div class="absolute bottom-12 -right-2 sm:-right-4 bg-white/95 backdrop-blur-md px-3.5 py-2 rounded-2xl shadow-md border border-slate-100 flex items-center gap-2.5 transform rotate-3 hover:rotate-0 transition-transform z-10">
                           <span class="text-lg">📚</span>
                           <div>
                       ...
                       <div class="absolute -bottom-4 bg-emerald-50 border border-emerald-100 text-emerald-700 px-4 py-1.5 rounded-full text-xs font-extrabold shadow-sm flex items-center gap-1.5 z-20">
   ...
   <section id="features" class="py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
       <div class="max-w-6xl mx-auto space-y-12">
           ...
           <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
               ...
               <!-- Card 1: AI Receipt Scanner -->
               <div class="bg-white border border-slate-100 rounded-[2rem] p-8 shadow-sm hover:shadow-md transition-all duration-300 space-y-4">
   ...
   <section id="how-it-works" class="py-12 px-4 sm:px-6 lg:px-8">
       <div class="max-w-6xl mx-auto">
           <div class="bg-indigo-600 rounded-[2.5rem] p-8 sm:p-14 text-white shadow-xl shadow-indigo-600/10 space-y-10">
               ...
               <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                   ...
                   <div class="bg-white/10 backdrop-blur-md border border-white/10 rounded-3xl p-6 sm:p-8 space-y-4">
   ...
   <section id="comparison" class="py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
       <div class="max-w-5xl mx-auto space-y-10">
           ...
           <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
               ...
               <div class="bg-rose-50/50 border border-rose-100 rounded-[2rem] p-8 space-y-5">
               ...
               <!-- SampleName Way -->
               <div class="bg-indigo-50/50 border border-indigo-100 rounded-[2rem] p-8 space-y-5 shadow-sm">
