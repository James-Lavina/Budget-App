    ...
    <div class="max-w-xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
            <div class="border-b border-slate-100 pb-5 mb-6">
                <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Modify Transaction</h1>
                <p class="text-sm text-slate-500 mt-1">
                    Correct any logging mistakes. The framework recalculates daily limits automatically.
                </p>
            </div>
            ...
            <form wire:submit.prevent="updateExpense" class="space-y-5">
                ...
                <div class="pt-4 flex items-center justify-end gap-3">
                    ...
                    <button type="submit" wire:loading.attr="disabled"
                        ...
                        <span wire:loading>Saving adjustments...</span>
                    </button>
                </div>
