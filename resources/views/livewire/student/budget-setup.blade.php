    ...
    <div class="max-w-5xl w-full bg-white rounded-[2rem] sm:rounded-[2.5rem] shadow-2xl shadow-indigo-950/10 border border-slate-100 grid grid-cols-1 lg:grid-cols-12 overflow-hidden">
        ...
        <div class="lg:col-span-6 bg-gradient-to-br from-indigo-600 via-indigo-600 to-indigo-700 p-6 sm:p-10 text-white flex flex-col justify-between space-y-6 sm:space-y-8 relative overflow-hidden">
            ...
            <div class="space-y-5 sm:space-y-6 relative z-10">
                ...
                <!-- Mascot & Safe-To-Spend Preview Card -->
                <div class="relative bg-white/95 rounded-3xl p-5 sm:p-6 shadow-xl border border-white/20 flex flex-col items-center justify-center min-h-[180px] sm:min-h-[200px]">
                    <img
                        src="{{ asset('images/undraw_budgeting_klon.svg') }}"
                        alt="Student illustration"
                        class="w-32 h-32 sm:w-36 sm:h-36 object-contain drop-shadow-sm"
                    >
                   
                    <!-- Floating Badge -->
                    <div class="absolute bottom-3 right-3 bg-white border border-slate-100 rounded-2xl p-2.5 shadow-lg flex flex-col text-left">
                        <span class="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Daily Spending</span>
                        <span class="text-xs sm:text-sm font-black text-emerald-600">Safe-To-Spend Limit</span>
                    </div>
                </div>
            </div>

            <!-- Footer Features -->
            <div class="flex items-center gap-5 text-xs font-semibold text-indigo-100/90 pt-4 relative z-10 border-t border-white/10">
            ...
            <div class="max-w-md w-full mx-auto space-y-6">
                ...
                <div class="space-y-1">
                    ...
                    <p class="text-xs sm:text-sm text-slate-500 font-medium">
                        Enter your weekly money to open your dashboard.
                    </p>
                </div>
                ...
                <form wire:submit.prevent="initializeEngine" class="space-y-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div>
                            <select id="reset_day" wire:model="reset_day"
                                ...
                                <option value="Monday">Monday (Start of school week)</option>
                                <option value="Tuesday">Tuesday</option>
                                <option value="Wednesday">Wednesday</option>
                                <option value="Thursday">Thursday</option>
                                <option value="Friday">Friday (Start of weekend)</option>
                    ...
                    <div class="bg-indigo-50/60 rounded-2xl p-4 border border-indigo-100/80 space-y-1 text-xs">
                        ...
                        <p class="text-slate-600 leading-relaxed">
                            ...
                            <span class="font-bold text-indigo-700 bg-white px-2 py-0.5 rounded-lg border border-indigo-100 inline-block shadow-xs">
                    ...
                    <div class="pt-2">
                        <button type="submit" wire:loading.attr="disabled"
                            ...
                            <span wire:loading.remove class="inline-flex items-center gap-2">
                                <span>Start Tracking My Spending</span>
