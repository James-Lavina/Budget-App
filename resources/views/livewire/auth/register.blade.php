<div class="min-h-screen bg-slate-100/80 flex items-center justify-center p-4 sm:p-6 lg:p-8 font-sans antialiased text-slate-800">
    ...
    <div class="max-w-5xl w-full bg-white rounded-[2.5rem] shadow-2xl shadow-indigo-950/10 border border-slate-100 overflow-hidden grid grid-cols-1 lg:grid-cols-12">
        
        <!-- LEFT COLUMN: Brand Hero Side -->
        <div class="lg:col-span-6 bg-gradient-to-br from-indigo-600 via-indigo-600 to-indigo-700 p-8 sm:p-10 text-white flex flex-col justify-between space-y-8 relative overflow-hidden">
            ...
            <div class="max-w-md w-full mx-auto space-y-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <p class="text-xs sm:text-sm text-slate-500 font-normal">
                        A calmer way to manage your allowance starts here.
                    </p>
                </div>
                ...
                <form wire:submit.prevent="registerUser" class="space-y-4">
                    ...
                    <!-- Full Name Field -->
                    <div class="space-y-1.5">
                        <label for="name" class="block text-xs font-bold text-slate-700 uppercase tracking-wider flex items-center gap-1.5">
                        ...
                        <div>
                            <input id="name" type="text" wire:model.lazy="name" placeholder="John Doe"
                                ...
                                @error('name') border-rose-300 text-rose-900 placeholder-rose-300 focus:border-rose-500 focus:ring-rose-500/20 bg-rose-50/30 @else border-slate-200 focus:border-indigo-600 focus:ring-indigo-600/20 text-slate-900 @enderror">
                        </div>
                        @error('name')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1.5">
                            <label for="password_confirmation" class="block text-xs font-bold text-slate-700 uppercase tracking-wider flex items-center gap-1.5">
