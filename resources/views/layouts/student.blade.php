...
<body class="h-full font-sans antialiased text-slate-800 bg-[#f4f6fa]">
            ...
            <div class="space-y-6">
                ...
                <div id="brand-row" class="flex items-center justify-between px-2 pt-1">
                    <a href="{{ route('student.dashboard') }}" id="brand-link" class="flex items-center gap-3 min-w-0">
                        <div class="h-10 w-10 bg-indigo-600 rounded-2xl flex items-center justify-center text-white shadow-md shadow-indigo-600/30 shrink-0">
                        ...
                        <span data-sidebar-label class="font-black text-slate-900 text-xl tracking-tight truncate">BudgetApp</span>
                    </a>
                ...
                <nav class="space-y-1.5">
                    <a href="{{ route('student.dashboard') }}" title="Dashboard" data-sidebar-nav-item
                    ...
                    <a href="{{ route('student.expenses.create') }}" title="Add Expense" data-sidebar-nav-item
                    ...
                    <a href="{{ route('student.receipt-scanner') }}" title="Receipt Scanner" data-sidebar-nav-item
                    ...
                    <a href="{{ route('student.forecast') }}" title="Spending Forecast" data-sidebar-nav-item
                    ...
                    <a href="{{ route('student.goals') }}" title="Savings Goal" data-sidebar-nav-item
                    ...
                    <a href="{{ route('student.simulation') }}" title="Purchase Simulator" data-sidebar-nav-item
                    ...
                    <a href="{{ route('student.notifications') }}" title="Notifications" data-sidebar-nav-item
                    ...
                    <a href="{{ route('student.profile') }}" title="Profile" data-sidebar-nav-item
                    ...
                    <a href="{{ route('student.settings') }}" title="Settings" data-sidebar-nav-item
    ...
    <!-- Vanilla JavaScript for Mobile Sidebar Toggle + Desktop Collapse -->
    <script>
